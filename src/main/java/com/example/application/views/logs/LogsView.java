package com.example.application.views.logs;
 ...
 */
@JsModule("./views/logs/logs-view.ts")
@CssImport("./views/logs/logs-view.css")
@Tag("logs-view")
@ParentLayout(MainView.class)
@PageTitle("Logs")
public class LogsView extends LitTemplate implements AfterNavigationObserver {
