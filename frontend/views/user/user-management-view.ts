...
<vaadin-vertical-layout style="width: 100%; height: 95%;" theme="spacing">
 <div class="overallDiv" style="align-self: center; flex-grow: 1; height: 100%; width: 95%;">
  ...
  <vaadin-vertical-layout theme="spacing" id="gridLayout" style="margin: var(--lumo-space-m); height: 90%; margin-top: var(--lumo-space-m);">
   <vaadin-grid id="usersGrid" loading size="50" theme="column-borders" style="height: 90%; margin-bottom: var(--lumo-space-m);"></vaadin-grid>
  </vaadin-vertical-layout>
 </div>
</vaadin-vertical-layout>
`;
